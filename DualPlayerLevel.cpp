...
void DualPlayerLevel::Load()
{
	Super::Load();
}

void DualPlayerLevel::Unload()
{
	Super::Unload();
}

void DualPlayerLevel::InitLevel()
{
	Super::InitLevel();
	GenerateLevel();
}

void DualPlayerLevel::GenerateLevel()
{
	...
	_grassVariants.push_back(new LevelElement(new Grass(CircleShapeData(_grassSize, "Object/Grass_2")), 2));
	LevelElement* _grass = new LevelElement(new Grass(CircleShapeData(_grassSize, "Object/Grass_1")), 5, _grassVariants);
	...
	_rockVariants.push_back(new LevelElement(new Rock(CircleShapeData(_rockSize, "Object/Rock_1")), 1));
	_rockVariants.push_back(new LevelElement(new Rock(CircleShapeData(_rockSize, "Object/Rock_2")), 1));
	_rockVariants.push_back(new LevelElement(new Rock(CircleShapeData(_rockSize, "Object/Rock_3")), 1));
	LevelElement* _rock = new LevelElement(new Rock(CircleShapeData(_rockSize, "Object/Rock_4")), 3, _rockVariants);
