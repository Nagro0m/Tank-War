...
Bullet::Bullet(const Vector2f& _direction) : MeshActor(RectangleShapeData(Vector2f(50.0f, 50.0f), "Tank/Bullet/Bullet"), "BulletActor")
{
	SetLifeSpan(GetRandomNumberInRange(2, 4));
...
{
	ExplosionAnimation* _explosion = M_LEVEL.GetCurrentLevel()->SpawnActor<ExplosionAnimation>(ExplosionAnimation(RectangleShapeData(Vector2f(30, 30), "Effects/Explosion")));
